...
const Sidebar = () => {
  const { sidebarCollapsed, toggleSidebar, favorites, isFavorite } = useApp();
  ...
  if (sidebarCollapsed) {
    return (
      <aside className="dw-sidebar collapsed">
        <button className="dw-sidebar-toggle" onClick={toggleSidebar} title="Expand sidebar">
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  if (tools.length > 0) navigate(`/tool/${tools[0].id}`);
                }}
                title={cat.name}
  ...
  return (
    <aside className="dw-sidebar">
      <div className="dw-sidebar-header">
        <button className="dw-sidebar-toggle" onClick={toggleSidebar} title="Collapse sidebar">
